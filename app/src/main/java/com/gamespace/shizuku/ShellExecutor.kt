...
class ShellExecutor @Inject constructor(
    ...
    /**
     * `Shizuku.newProcess` bị đánh dấu private kể từ shizuku-api 13.x (dự kiến gỡ bỏ hoàn toàn
     * theo lộ trình chuyển sang UserService/AIDL — xem KDoc đầu file). Tạm thời gọi qua reflection
     * để giữ hành vi cũ; khi nâng cấp lên UserService, xóa hàm này.
     */
    private fun newShizukuProcess(command: Array<String>): ShizukuRemoteProcess {
