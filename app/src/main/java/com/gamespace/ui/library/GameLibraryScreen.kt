...
import com.gamespace.ui.icons.filled.PlayArrow
import com.gamespace.ui.icons.filled.Star
import com.gamespace.ui.icons.outlined.Star
...
private fun ProfileDropdown(
    ...
    ExposedDropdownMenuBox(expanded = expanded, onExpandedChange = { expanded = it }, modifier = modifier) {
        OutlinedTextField(
            value = selected?.let { it.displayName } ?: "Mặc định hệ thống",
            onValueChange = {},
            readOnly = true,
