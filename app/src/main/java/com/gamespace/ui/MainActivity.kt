...
// LƯU Ý: đây là extension property trên Icons.Filled/Icons.Outlined — dù đã alias qua "as" ở
// import, vẫn phải gọi kèm receiver (Icons.Filled.<alias>), không thể dùng tên trống.
private val gsNavItems = listOf(
    GsNavItem(GameSpaceDestinations.PLAYTIME, "Thời gian chơi", Icons.Filled.AccessTimeFilled, Icons.Outlined.AccessTimeOutlined),
    GsNavItem(GameSpaceDestinations.G_HOME, "G-Home", Icons.Filled.HomeFilled, Icons.Outlined.HomeOutlined),
    GsNavItem(GameSpaceDestinations.PROFILE, "Hồ sơ", Icons.Filled.PersonFilled, Icons.Outlined.PersonOutlined),
)
