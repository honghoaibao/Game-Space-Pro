...
class OverlayService : Service() {
    ...
    private fun buildNotification() =
        NotificationCompat.Builder(this, GameSpaceApp.CHANNEL_OVERLAY)
            ...
            .setOngoing(true)
            // setPriority: tương thích ngược cho Android < O (channel importance chỉ có hiệu lực
            // từ API 26). setCategory(CATEGORY_SERVICE): đánh dấu rõ đây là thông báo của một
            // service đang chạy thật — một số OEM dùng category này làm tín hiệu để KHÔNG dọn nền,
            // xem ghi chú đầy đủ ở GameSpaceApp.createNotificationChannels().
